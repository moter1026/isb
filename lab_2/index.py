...
def main() -> None:
    ...
    try:
        ...
        print(f"{consts.COLOR_RED} Ошибка {err} при открытии файла " +
              f"{consts.SEQUENCE_CPP}{consts.COLOR_RESET}")
    ...
    try:
        ...
        print(f"{consts.COLOR_RED} Ошибка {err} при открытии файла " +
              f"{consts.SEQUENCE_JAVA}{consts.COLOR_RESET}")
    ...
    try:
        ...
        print(f"{consts.COLOR_RED} Ошибка {err} при выполнении тестов {consts.COLOR_RESET}")
